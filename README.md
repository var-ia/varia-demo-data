...
Safe, publicly-sourced demo datasets for [Refract](https://github.com/var-ia/var-ia), the deterministic observation engine.
...
These datasets feed Refract's eval harness (`packages/eval/`). Point an eval config at `file://` paths in this repo to run deterministic analysis without hitting live APIs.
